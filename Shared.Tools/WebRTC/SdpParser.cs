...
public static class SdpParser
{
    public static string ParseToSdp(TransportData transportData)
    {
        ...
        string setupRole = transportData.DTLSData.Role == "server" ? "passive" : "active";
        
        string candidateStr = $"a=candidate:1 1 UDP 2130706431 {transportData.ServerIp} {transportData.ServerPort} typ host";
        ...
        sdp.AppendLine($"m=audio {transportData.ServerPort} UDP/TLS/RTP/SAVPF 14");
        sdp.AppendLine($"c=IN IP4 {transportData.ServerIp}");
        ...
        sdp.AppendLine($"m=video {transportData.ServerPort} UDP/TLS/RTP/SAVPF 96");
        sdp.AppendLine($"c=IN IP4 {transportData.ServerIp}");
